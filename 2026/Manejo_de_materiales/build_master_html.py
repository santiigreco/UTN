...
with open('master_catalog_processed.json', 'r', encoding='utf-8') as f:
    items = json.load(f)
...
def get_freq_level(freq):
    if freq >= 7:
        return ('critica', '🔥 MUY ALTA (7-10x)', '#ef4444', 'rgba(239, 68, 68, 0.15)')
    elif freq >= 5:
...
<head>
  ...
  <meta name="description" content="Guía de estudio exhaustiva y optimizada para parciales y finales de Manejo de Materiales y Distribución en Planta (UTN FRBA - Cátedra Grimolizzi). Incluye 1P 2026, fotos manuscritas y banco histórico ordenado por frecuencia exacta con respuestas verbatim oficiales." />
...
<div class="app-container">
  ...
  <header>
    <div class="header-top">
      ...
      <div style="font-size: 0.82rem; color: var(--text-dim); font-family: 'JetBrains Mono', monospace;">Banco Maestro Completo • Ciclo 2024 / 2025 / 2026</div>
    </div>
    <h1>Manejo de Materiales <span>& Distribución en Planta</span></h1>
    <p class="header-desc">
      Guía Maestra de Estudio consolidada con todas las preguntas de <strong>1° y 2° Parciales, Recuperatorios, 1P 2026, Fotos Manuscritas y Finales</strong>. Ordenadas estrictamente por frecuencia de aparición con <strong>respuestas literales oficiales (verbatim)</strong> de las presentaciones de la cátedra.
    </p>
  ...
  <div class="toolbar-sticky">
    <div class="toolbar-main-row">
      <div class="search-wrapper">
        ...
        <input type="text" id="searchInput" class="search-input" placeholder="Buscar concepto, palabra clave, fórmula, norma, autor (Weber, Muther, LEED)..." oninput="handleSearch()" />
      </div>
    ...
    <div class="filter-pills-row">
      <button class="filter-pill active" onclick="setUnitFilter('all', this)">Todas (60)</button>
  ...
  <div class="active-count" id="activeCounter">
    Mostrando <strong id="visibleCount">60</strong> preguntas de 60
  </div>
...
print("Saved complete 60-question Guia_Maestra_Parciales_Manejo_de_Materiales.html successfully!")
