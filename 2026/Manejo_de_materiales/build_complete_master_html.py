...
def get_freq_level(freq):
    if freq >= 10:
        return ('critica', f'🔥 CRÍTICA ({freq}x)', '#ef4444', 'rgba(239, 68, 68, 0.15)')
    elif freq >= 6:
        return ('alta', f'⚡ MUY ALTA ({freq}x)', '#f59e0b', 'rgba(245, 158, 11, 0.15)')
    elif freq >= 3:
        return ('media', f'📌 ALTA ({freq}x)', '#06b6d4', 'rgba(6, 182, 212, 0.15)')
    else:
        return ('estandar', f'🔹 MEDIA ({freq}x)', '#8b5cf6', 'rgba(139, 92, 246, 0.15)')
...
<head>
  ...
  <title>Guía Maestra Exhaustiva de Estudio – Manejo de Materiales UTN FRBA</title>
  <meta name="description" content="Guía maestra de estudio exhaustiva para Manejo de Materiales y Distribución en Planta (UTN FRBA - Cátedra Grimolizzi). 75 temas y preguntas consolidadas del banco histórico total con respuestas literales verbatim oficiales." />
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .response-container { margin-bottom: 1.25rem; }
    ...
    body.flashcard-mode .verbatim-block:hover { filter: blur(3px); }
    body.flashcard-mode .verbatim-block.revealed { filter: none; user-select: auto; }
    ...
    .source-tag strong { color: #38bdf8; font-weight: 600; }
...
<div class="app-container">
  ...
  <header>
    <div class="header-top">
      ...
      <div style="font-size: 0.82rem; color: var(--text-dim); font-family: 'JetBrains Mono', monospace;">Banco Exhaustivo Total • Ciclo 2024 / 2025 / 2026</div>
    </div>
    <h1>Manejo de Materiales <span>& Distribución en Planta</span></h1>
    <p class="header-desc">
      Guía Maestra Exhaustiva de Estudio con <strong>75 temas y preguntas consolidadas</strong> a partir de <strong>1° y 2° Parciales, Recuperatorios, 1P 2026, Fotos Manuscritas y Exámenes Finales</strong>. Ordenadas estrictamente por frecuencia de aparición con <strong>respuestas oficiales íntegras y literales (verbatim)</strong> de las presentaciones de la cátedra.
    </p>
...
print("Saved exhaustive 75-question Guia_Maestra_Parciales_Manejo_de_Materiales.html successfully!")
